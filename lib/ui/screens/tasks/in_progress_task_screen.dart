                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return TaskListTile(
                              ...
                              onDeleteTap: () {
                                ManageDataUtility.showDeleteAlertDialog(context, _inProgressTaskController.taskListModel.data![index].sId!, _inProgressTaskController.taskListModel, () {
                                  setState(() {});
                                });
                              },
                              onEditTap: () {
                                ManageDataUtility.showStatusUpdateBottomSheet(context, _inProgressTaskController.taskListModel.data![index], () {_inProgressTaskController.getInProgressTasks(); });
                              },
                            );
                          },
